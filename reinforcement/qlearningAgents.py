...
class QLearningAgent(ReinforcementAgent):
    ...
    #Q-LEARNING AGENT(percept) returns action
        #inputs: percept, a percept indicating current state s' and reward signal r'
        # persistent:
            #Q, a table of action values index by a state and action, initially zero
            #N_sa, a table of frequenceies for state-action pairs, initially zero
            #s, a, r- previous state, action, and reward, initiall null
        #if TERMINAL?(s) then Q[s, None] = r'
        #if s is not null then
            #increment N_sa[s, a]
            #Q[s, a] = Q[s, a]+ alpha(N_sa[s, a])(r + lambdamax_a' Q[s', a'] - Q[s,a])
        #s, a, r = s', argmaxa' f(Q[s',a'], N_sa[s',a']), r'
        #return a        
